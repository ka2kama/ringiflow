...
PRレビュー時は、本ドキュメントの「プロジェクト理念」セクションに基づき、以下の観点でレビューする:

**品質（理念2）:**
- 外部品質: 信頼性、パフォーマンス、セキュリティ、ユーザビリティ
- 内部品質: 可読性、保守性、テスタビリティ
- 型システムの活用（Rust/Elm の強みを活かしているか）
- テストの有無と品質
...
**プロジェクト固有のルール:**
- データストア追加時のテナント削除対応（該当する場合）
- ドキュメント規約の遵守

### 使い方

- **自動レビュー:** PRオープン/更新時に自動実行
