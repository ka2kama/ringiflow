...
| 改善記録 / 調査記録 / 診断レポート | [`process/improvements/`](process/improvements/) / [`process/investigations/`](process/investigations/) / [`process/reports/`](process/reports/) |
...
- **調査記録** — 仮説検証 2 回以上のトラブルシューティング（→ [`process/investigations/`](process/investigations/)）
