...
### 確認事項
- [ ] パターン: README の「対策形式の検証」セクション（L79-97）→ 必須検討事項として追加するパターン
- [ ] パターン: README の「分類」セクション（L113-167）→ 必須フィールドパターン
...
### 確認事項
- [ ] パターン: problem-solving.md の「適用場面」セクション → L7 付近
- [ ] パターン: troubleshooting.md との境界 → 技術的問題専用
...
### 確認事項
- [ ] パターン: wrap-up SKILL.md の改善記録セクション → L114-121（3 ステップ）
