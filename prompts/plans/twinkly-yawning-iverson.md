...
| 成果物 | ファイルパス |
|--------|-----------|
| ADR | `docs/05_ADR/029_人間向け表示用IDの導入.md` |
| 詳細設計書 | `docs/03_詳細設計書/12_表示用ID設計.md` |
| ID 設計規約の更新 | `docs/03_詳細設計書/04_ID設計規約.md` |
...
`docs/05_ADR/029_人間向け表示用IDの導入.md`
...
`docs/03_詳細設計書/04_ID設計規約.md` に表示用 ID セクションを追記。
