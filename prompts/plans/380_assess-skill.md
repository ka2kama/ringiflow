...
| ソース | パス | 取得方法 |
|--------|------|---------|
| 実装ロードマップ | `docs/03_詳細設計書/00_実装ロードマップ.md` | Read |
| 機能仕様書 | `docs/01_要件定義書/機能仕様書/` | Glob + Read |
| コア要件 | `docs/01_要件定義書/01_コア要件.md` | Read |
| 設計書の実装状態マーカー | `docs/02_基本設計書/`, `docs/03_詳細設計書/` | Grep `実装状態` |
| ADR | `docs/05_ADR/` | Glob（件数と最新を確認） |
...
| ADR 記録状況 | Glob `docs/05_ADR/*.md` の件数 | 情報提供のみ |
