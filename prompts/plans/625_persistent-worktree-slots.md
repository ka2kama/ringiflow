...
| `.gitignore` | 変更 |
| `docs/04_手順書/04_開発フロー/04_並行開発（Worktree）.md` | 全面改訂 |
| `docs/05_ADR/021_並行開発環境の構成.md` | 補遺追加 |
| `docs/07_実装解説/03_並行開発環境/*.md` | 改訂 |
...
- [ ] パターン: ADR の変更履歴フォーマット → `docs/05_ADR/021_並行開発環境の構成.md` L93-97
- [ ] パターン: 実装解説のセクション構成
