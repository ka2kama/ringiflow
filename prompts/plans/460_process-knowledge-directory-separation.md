...
| ファイル | 変更内容 |
|---------|---------|
| `docs/02_基本設計書/02_プロジェクト構造設計.md` | ディレクトリ構造図に `process/` を追加 |
| `docs/04_手順書/04_開発フロー/01_Issue駆動開発.md` | 改善記録パス、grep コマンド |
| `docs/05_ADR/046_Story-per-PRブランチ戦略.md` | 改善記録リンク |
| `docs/06_ナレッジベース/methodology/AI思考特性の分析ガイド.md` | パスとリンク |
| `docs/06_ナレッジベース/methodology/SRE的アプローチ.md` | 改善記録 README リンク |
| `docs/06_ナレッジベース/methodology/AIエージェント主導開発のアプローチ比較.md` | 改善記録リンク |
| `README.md` | 改善記録パス |
...
`docs/05_ADR/050_プロセス知識ディレクトリの分離.md` を作成する。
