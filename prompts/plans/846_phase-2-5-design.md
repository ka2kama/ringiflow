...
- `docs/20_機能仕様書/00_はじめに.md`（更新: 読む順序に追加）

#### 確認事項
- テンプレート: `docs/20_機能仕様書/00_はじめに.md`
- 既存パターン: `01_ワークフロー管理.md`, `04_ワークフローデザイナー.md`
- 要件: `docs/10_要件定義書/01_コア要件.md` NOTIFY-001, DOC-001, DOC-003
...
成果物: `docs/40_詳細設計書/16_通知機能設計.md`（新規）

#### 確認事項
- パターン: `docs/40_詳細設計書/15_ワークフローデザイナー設計.md`
- 基本設計: `docs/30_基本設計書/01_アーキテクチャ設計.md` BATCH-203, `03_インフラとDB設計.md` notifications テーブル
- 既存インフラ: `infra/docker/docker-compose.yaml`
- テナント退会: `docs/40_詳細設計書/06_テナント退会時データ削除設計.md`
- 既存イベントパターン: `backend/crates/shared/src/event_log.rs`
- API 設計パターン: `docs/40_詳細設計書/03_API設計.md`
...
成果物: `docs/40_詳細設計書/17_ドキュメント管理設計.md`（新規）

#### 確認事項
- S3 設計: `docs/40_詳細設計書/06_テナント退会時データ削除設計.md` S3 パス設計
- S3 バケット: `docs/30_基本設計書/03_インフラとDB設計.md` `ringiflow-{env}-documents`
...
- ブランチ戦略: `docs/70_ADR/046_Story-per-PRブランチ戦略.md`
...
| ファイル | 用途 |
|---------|------|
| `docs/20_機能仕様書/00_はじめに.md` | 機能仕様書テンプレート |
| `docs/20_機能仕様書/04_ワークフローデザイナー.md` | 最新の機能仕様書パターン |
| `docs/40_詳細設計書/15_ワークフローデザイナー設計.md` | 最新の詳細設計書パターン |
| `docs/40_詳細設計書/06_テナント退会時データ削除設計.md` | S3 パス設計、削除対象 |
| `docs/40_詳細設計書/00_実装ロードマップ.md` | Phase 2-5 スコープ・完了基準 |
| `docs/30_基本設計書/03_インフラとDB設計.md` | S3 バケット構成、DynamoDB 設計 |
| `backend/crates/domain/src/workflow/instance.rs` | WorkflowInstanceStatus（通知トリガー） |
| `docs/10_要件定義書/01_コア要件.md` | NOTIFY-001, DOC-001, DOC-003 要件 |
