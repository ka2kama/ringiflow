...
- `docs/40_詳細設計書/00_実装ロードマップ.md` — Phase 定義と完了基準
...
デプロイ基盤に依存しないアプリケーション構造を示す。ロードマップの Phase 1 アーキテクチャ図（`docs/40_詳細設計書/00_実装ロードマップ.md:157-178`）と整合させる。
...
- ロードマップ（`docs/40_詳細設計書/00_実装ロードマップ.md`）の更新 — 別 Issue
