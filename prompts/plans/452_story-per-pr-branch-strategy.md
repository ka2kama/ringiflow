...
- [x] ADR テンプレート → `docs/05_ADR/template.md`
- [x] 最新 ADR 番号 → ADR-045（次は ADR-046）
- [x] 関連 ADR → ADR-012（Issue 駆動開発）、ADR-013（Draft PR 運用）

### 作業内容

ファイル: `docs/05_ADR/046_Story-per-PRブランチ戦略.md`
...
- [x] 現在の Epic/Story 運用フロー → `docs/04_手順書/04_開発フロー/01_Issue駆動開発.md` L647-726
...
- [x] 現在のブランチ戦略セクション → `docs/02_基本設計書/04_運用設計.md` L408-431

### 作業内容

ファイル: `docs/02_基本設計書/04_運用設計.md`
