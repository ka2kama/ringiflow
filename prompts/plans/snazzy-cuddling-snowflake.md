...
改善記録 [Epic の Story 進捗が未記録](../improvements/2026-02/2026-02-14_2230_EpicのStory進捗が未記録.md) への対策。Epic #467 の Story 1（#511）完了時に Epic タスクリストが更新されなかった問題を、手順書にステップを追加することで構造的に防止する。
