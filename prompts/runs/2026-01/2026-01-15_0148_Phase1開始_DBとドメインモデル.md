...
**関連ドキュメント**:
- [実装ロードマップ](../../../docs/40_詳細設計書/00_実装ロードマップ.md)
- [データベース設計](../../../docs/40_詳細設計書/02_データベース設計.md)
- [Rust実装ルール](../../../.claude/rules/rust.md)
- [リポジトリ層実装ルール](../../../.claude/rules/repository.md)

**関連技術ノート**:
- [Newtype パターン](../../../docs/80_ナレッジベース/rust/Newtypeパターン.md)（新規作成）
- [ドメイン駆動設計エンティティ](../../../docs/80_ナレッジベース/architecture/DDD_エンティティパターン.md)（新規作成）
