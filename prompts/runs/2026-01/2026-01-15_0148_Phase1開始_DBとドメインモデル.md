...
**関連ドキュメント**:
- [実装ロードマップ](../../../docs/03_詳細設計書/00_実装ロードマップ.md)
- [データベース設計](../../../docs/03_詳細設計書/02_データベース設計.md)
- [Rust実装ルール](../../../.claude/rules/rust.md)
- [リポジトリ層実装ルール](../../../.claude/rules/repository.md)

**関連技術ノート**:
- [Newtype パターン](../../../docs/06_ナレッジベース/rust/Newtypeパターン.md)（新規作成）
- [ドメイン駆動設計エンティティ](../../../docs/06_ナレッジベース/architecture/DDD_エンティティパターン.md)（新規作成）
- [sqlx-cli](../../../docs/06_ナレッジベース/rust/sqlx-cli.md)
