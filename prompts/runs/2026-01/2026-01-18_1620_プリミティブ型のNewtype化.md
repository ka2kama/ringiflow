...
| `docs/70_ADR/016_プリミティブ型のNewtype化方針.md` | 新規作成 |
...
- [ADR-016: プリミティブ型の Newtype 化方針](../../../docs/70_ADR/016_プリミティブ型のNewtype化方針.md)
- [技術ノート: Newtype パターン](../../../docs/80_ナレッジベース/rust/Newtypeパターン.md)
