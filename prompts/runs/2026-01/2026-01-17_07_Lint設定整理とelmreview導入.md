...
> lint に format-check が抜けていませんか？

> Elm の lint が format-check だけになっていませんか？

> format-check と lint を分ける意味が薄くありませんか？

> コミット時に lint と test が通ることを保証したいです。

> WIP コミットもあるので、Claude Code に保証させれば一旦はそれで良いです。
