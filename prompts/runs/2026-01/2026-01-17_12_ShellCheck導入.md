...
- [ADR-015: 開発スクリプトの品質担保方針](../../docs/05_ADR/015_開発スクリプトの品質担保方針.md)
...
- `docs/04_手順書/01_開発参画/01_開発環境構築.md`
- `CLAUDE.md`
...
> 開発中は様々なツールやスクリプトで効率化をはかっている。しかし、これらの自作ツールやスクリプト類の正しさはどう担保するのか？

> このプロジェクトの理念、目的、要件、今後の規模感あたりを加味した上での最適解は？

> ローカルにできるものはローカルでよい。

> ripgrep を求めるのは酷か？

> check-tools と手順書は毎回同時更新したい。
