...
ユーザーから、バックエンドを BFF と Core API に分けているが、そもそも認証基盤は Core API に含めてよいのか、別の専用 API を用意すべきではないかという問題提起があった。

### YAGNI との折り合い

現状では過剰であることはある程度理解しつつも、プロジェクトの理念、目的、要件から総合的に考えたいという方針が示された。特にこのレベルの上流アーキテクチャの場合、後からコロコロ変更するものではなく、YAGNI は尊重しつつも「なんとかなれ精神」ではいきたくないとのことだった。

### 学習への興味

個人的な学習への興味という意味では、Auth Service をある程度作ってみたいという要望があった。

### Epic/Story 運用の導入

Epic や Story といったプロジェクト管理のベストプラクティスをフローに組み込みたいという要望があり、GitHub Projects との連携を整備した。
