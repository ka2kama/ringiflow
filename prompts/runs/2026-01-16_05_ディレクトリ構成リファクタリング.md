...
- 技術ノート: [モノレポディレクトリ構成](../../docs/05_技術ノート/モノレポディレクトリ構成.md)
...
> ディレクトリ構成について。packages がトップレベルにいていいのですか？

> 汎用的といいながら packages の直下が domain, infra など Rust プロジェクトなのが違和感があります。

> そもそもトップレベルにいていいのですか？

> backend, frontend, その他今あるもの、あるいは今後増えそうなもの、そのあたりを全部加味して、最適な構成を考えてください。

> トップレベルの .env.template の RUST_LOG とかいるのですか？

> frontend に .env はいりますか？
