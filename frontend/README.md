...
これらはグローバルインストールする。
理由は [ADR-002](../../docs/04_ADR/002_フロントエンドツールチェーンの選定.md) を参照。
...
Volta でプロジェクト固有の Node.js バージョンを固定。
Volta がインストールされていれば、このディレクトリで
自動的に Node.js 22.16.0 が使用される。
...
- [開発環境構築手順](../../docs/03_手順書/01_開発環境構築.md)
- [Elm プロジェクト構築手順](../../docs/03_手順書/04_Elmプロジェクト構築.md)
- [ADR-002: フロントエンドツールチェーンの選定](../../docs/04_ADR/002_フロントエンドツールチェーンの選定.md)
