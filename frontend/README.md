...
これらはグローバルインストールする。
理由は [ADR-002](../../docs/70_ADR/002_フロントエンドツールチェーンの選定.md) を参照。
...
自動的に指定バージョンが使用される。
経緯は [ADR-052](../../docs/70_ADR/052_Node.jsバージョン管理のmiseへの移行.md) を参照。
...
- [開発環境構築手順](../../docs/60_手順書/01_開発参画/01_開発環境構築.md)
- [ADR-002: フロントエンドツールチェーンの選定](../../docs/70_ADR/002_フロントエンドツールチェーンの選定.md)
