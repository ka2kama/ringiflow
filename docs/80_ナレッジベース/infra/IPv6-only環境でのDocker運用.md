...
> **注記**: [ADR-047](../../70_ADR/047_LightsailのIPv6-onlyからデュアルスタックへの切り替え.md) により、Lightsail はデュアルスタックに切り替え済み。本ドキュメントは IPv6-only 環境での知見の記録として残す。
...
- [ADR-030: Lightsail 個人環境の構築](../../70_ADR/030_Lightsail個人環境の構築.md)
