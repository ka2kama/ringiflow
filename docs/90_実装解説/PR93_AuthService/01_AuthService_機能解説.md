...
| 項目 | 内容 |
|------|------|
| 詳細設計書 | [`docs/40_詳細設計書/08_AuthService設計.md`](../../40_詳細設計書/08_AuthService設計.md) |
| ADR | [`docs/70_ADR/017_AuthService分離の方針.md`](../../70_ADR/017_AuthService分離の方針.md) |
...
機能・仕組みレベルの判断を記載する。コード実装レベルの判断は[コード解説](./02_AuthService_コード解説.md#設計解説)を参照。
...
- [ADR: AuthService 分離の方針](../../70_ADR/017_AuthService分離の方針.md)
- [詳細設計書: AuthService 設計](../../40_詳細設計書/08_AuthService設計.md)
