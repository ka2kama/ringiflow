...
[ADR-001](../../70_ADR/001_ID形式の選定.md) の決定に基づき、全エンティティの主キーに UUID を使用していた。UUID はシステム的には優れているが、運用上の課題があった。
...
| 項目 | 内容 |
|------|------|
| ADR | [ADR-029: 人間向け表示用 ID の導入](../../70_ADR/029_人間向け表示用IDの導入.md) |
| 詳細設計書 | [12_表示用 ID 設計](../../40_詳細設計書/12_表示用ID設計.md) |
| ID 設計規約 | [04_ID 設計規約](../../40_詳細設計書/04_ID設計規約.md) |
...
- [ADR-029: 人間向け表示用 ID の導入](../../70_ADR/029_人間向け表示用IDの導入.md)
- [ADR-001: ID 形式の選定](../../70_ADR/001_ID形式の選定.md)
- [詳細設計書: 表示用 ID 設計](../../40_詳細設計書/12_表示用ID設計.md)
- [詳細設計書: ID 設計規約](../../40_詳細設計書/04_ID設計規約.md)
