...
| 対象 | 遷移 |
|------|------|
| 操作対象のステップ | Active → Completed(RequestChanges) |
| 残りの Pending ステップ | Pending → Skipped |
...
sequenceDiagram
    ...
    Note over Core: 権限チェック: 申請者本人か
    Note over Core: 楽観的ロック: バージョン一致確認
