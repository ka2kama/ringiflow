...
認証機能設計書（[07_認証機能設計.md](../../40_詳細設計書/07_認証機能設計.md)）が `/internal/users/{user_id}` レスポンスにテナント情報を含める構造を規定しており、これに従った。
...
機能・仕組みレベルの判断を記載する。コード実装レベルの判断は[コード解説](./02_テナント情報取得_コード解説.md#設計解説)を参照。
...
- [コード解説](./02_テナント情報取得_コード解説.md)
- 設計書: [07_認証機能設計.md](../../40_詳細設計書/07_認証機能設計.md)
