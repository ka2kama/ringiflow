...
機能・仕組みレベルの判断を記載する。コード実装レベルの判断は[コード解説](./02_フォームdirty-state_コード解説.md#設計解説)を参照。
...
- [コード解説](./02_フォームdirty-state_コード解説.md)
- [ナレッジベース: Elm ポート](../../80_ナレッジベース/elm/Elmポート.md)
- [ナレッジベース: Elm アーキテクチャ](../../80_ナレッジベース/elm/Elmアーキテクチャ.md)
