...
| 型/関数 | ファイル | 責務 |
|--------|---------|------|
| `Model` | [`New/Types.elm:36`](../../../frontend/src/Page/Workflow/New/Types.elm) | ページ全体のモデル（shared, users, state） |
| `PageState` | [`New/Types.elm:49`](../../../frontend/src/Page/Workflow/New/Types.elm) | 型安全ステートマシン（Loading / Failed / Loaded） |
| `LoadedState` | [`New/Types.elm:57`](../../../frontend/src/Page/Workflow/New/Types.elm) | 定義一覧 + FormState |
| `FormState` | [`New/Types.elm:68`](../../../frontend/src/Page/Workflow/New/Types.elm) | 定義選択前後の状態（SelectingDefinition / Editing） |
| `EditingState` | [`New/Types.elm:78`](../../../frontend/src/Page/Workflow/New/Types.elm) | フォーム入力中の全状態（9 フィールド） |
| `Msg` | [`New/Types.elm:127`](../../../frontend/src/Page/Workflow/New/Types.elm) | 全メッセージ定義（16 バリアント） |
| `initEditing` | [`New/Types.elm:104`](../../../frontend/src/Page/Workflow/New/Types.elm) | EditingState の初期化 |
