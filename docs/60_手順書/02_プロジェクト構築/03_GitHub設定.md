...
- PR 本文（概要, 確認項目等）がコミットメッセージの body に含まれる
...
JSON パラメータの詳細は [ナレッジベース: GitHub Ruleset](../../80_ナレッジベース/devtools/GitHub_Ruleset.md) を参照。
...
→ 設計判断: [ADR-011](../../70_ADR/011_Claude_Code_Action導入.md)
