...
採用理由: [ADR-012: Issue 駆動開発の採用](../../70_ADR/012_Issue駆動開発の採用.md)
...
採用理由: [ADR-013: Draft PR 運用の導入](../../70_ADR/013_Draft_PR運用の導入.md)
...
→ ISO 25010 品質特性との対応: [KB: ISO 25010 > 品質チェックリストとのマッピング](../../80_ナレッジベース/methodology/ISO25010.md#品質チェックリストとのマッピング)
...
採用理由: [ADR-025: 情報管理とローカル知識集約の方針](../../70_ADR/025_情報管理とローカル知識集約の方針.md)
...
→ 意思決定: [ADR-046 Story-per-PR ブランチ戦略](../../70_ADR/046_Story-per-PRブランチ戦略.md)
