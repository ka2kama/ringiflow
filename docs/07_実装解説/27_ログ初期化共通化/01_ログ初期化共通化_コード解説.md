...
| 型/関数 | ファイル | 責務 |
|--------|---------|------|
| `LogFormat` | [`observability/mod.rs:12`](../../../backend/crates/shared/src/observability/mod.rs) | ログ出力形式の enum（Json / Pretty） |
| `TracingConfig` | [`observability/mod.rs:49`](../../../backend/crates/shared/src/observability/mod.rs) | サービス名とログ形式を保持する設定 |
| `init_tracing()` | [`observability/mod.rs:84`](../../../backend/crates/shared/src/observability/mod.rs) | グローバルトレーシングサブスクライバーの初期化 |
| `LogFormat::parse()` | [`observability/mod.rs:25`](../../../backend/crates/shared/src/observability/mod.rs) | 文字列から LogFormat へのパース（純粋関数） |
| `LogFormat::from_env()` | [`observability/mod.rs:39`](../../../backend/crates/shared/src/observability/mod.rs) | 環境変数 LOG_FORMAT からの読み取り |
| `TracingConfig::from_env()` | [`observability/mod.rs:68`](../../../backend/crates/shared/src/observability/mod.rs) | 環境変数から設定を構築するファクトリ |
...
```rust
// backend/crates/shared/src/observability/mod.rs:90-99
...
```rust
// backend/crates/shared/src/observability/mod.rs:87-88, 101-104
