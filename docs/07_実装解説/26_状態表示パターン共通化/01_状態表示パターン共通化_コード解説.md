...
| 型/関数 | ファイル | 責務 |
|--------|---------|------|
| `ErrorState.view` | [`Component/ErrorState.elm:49`](../../../frontend/src/Component/ErrorState.elm) | リフレッシュボタン付きエラー表示 |
| `ErrorState.viewSimple` | [`Component/ErrorState.elm:68`](../../../frontend/src/Component/ErrorState.elm) | シンプルなエラー表示 |
| `ErrorState.containerClass` | [`Component/ErrorState.elm:38`](../../../frontend/src/Component/ErrorState.elm) | テスト用 CSS クラス定数 |
...
```elm
-- frontend/src/Component/ErrorState.elm:49-65
view :
    { message : String
...
```elm
-- frontend/src/Component/ErrorState.elm:68-78
...
場所: `Component/ErrorState.elm:38`, `Component/EmptyState.elm:45`
