...
| `login()` | [`bff/handler/auth.rs:144`](../../../backend/apps/bff/src/handler/auth/mod.rs) | BFF ログインハンドラ |
| `logout()` | [`bff/handler/auth.rs:257`](../../../backend/apps/bff/src/handler/auth/mod.rs) | BFF ログアウトハンドラ |
| `me()` | [`bff/handler/auth.rs:298`](../../../backend/apps/bff/src/handler/auth/mod.rs) | BFF ユーザー情報取得ハンドラ |
| `csrf()` | [`bff/handler/auth.rs:349`](../../../backend/apps/bff/src/handler/auth/mod.rs) | BFF CSRF トークン取得ハンドラ |
...
コード実装レベルの判断を記載する。機能・仕組みレベルの判断は[機能解説](./01_認証機能_機能解説.md#設計判断)を参照。
