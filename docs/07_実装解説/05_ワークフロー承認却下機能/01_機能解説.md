...
[ワークフロー申請機能](../04_ワークフロー申請機能/01_バックエンド_機能解説.md)で、ユーザーがワークフローを下書き・申請する機能が実装済み。申請時に承認者を指定し、ステップが Active 状態で承認待ちとなる。
...
- [コード解説](./02_コード解説.md)
- [ワークフロー申請機能 - 機能解説](../04_ワークフロー申請機能/01_バックエンド_機能解説.md)
