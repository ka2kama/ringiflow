...
品質チェックリスト（6.2）の確認結果を **PR 本文の品質確認セクション** にカテゴリ別の確認内容として記載する。
...
| 日付 | 変更内容 |
|------|---------|
| 2026-02-25 | 品質CL 6.2 の参照テキストを更新: zoom-rhythm.md の責務（To-Be 宣言）との整合（#896） |
| 2026-02-24 | PR テンプレートのセクション名を日本語化（Summary→概要、Self-review→品質確認、Test plan→確認項目）、関連する参照をすべて更新（#897） |
...
| 2026-02-21 | 6.3 品質確認をチェックボックスから検証レポート形式（根拠付きリスト）に変更（#749） |
| 2026-02-21 | 6.3 品質確認をカテゴリ別チェックボックス形式に構造化（#745） |
