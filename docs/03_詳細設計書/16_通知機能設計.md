...
→ 機能仕様書: [05_通知機能.md](../01_要件定義書/機能仕様書/05_通知機能.md)
...
- [機能仕様書: 通知機能](../01_要件定義書/機能仕様書/05_通知機能.md)
- [コア要件（通知機能）](../01_要件定義書/01_コア要件.md) 4.5 節
- [アーキテクチャ設計 BATCH-203](../02_基本設計書/01_アーキテクチャ設計.md)
