...
- アーキテクチャ設計: [`docs/30_基本設計書/01_アーキテクチャ設計.md`](../30_基本設計書/01_アーキテクチャ設計.md) [5.3.1 Elm / Ports 連携要件]
- 実装: [`frontend/src/Route.elm`](../../frontend/src/Route.elm)
- 実装: [`frontend/src/Main.elm`](../../frontend/src/Main.elm)
