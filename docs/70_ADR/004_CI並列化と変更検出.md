...
含めていないもの:
- `.github/workflows/ci.yaml`: CI 設定自体の変更は手動確認が妥当
- `justfile`: 通常は他のファイルと一緒に変更される
- `docs/**`: ビルドに影響しない

### 関連ドキュメント

- 手順書: [`docs/60_手順書/02_プロジェクト構築/01_CICD構築.md`](../60_手順書/02_プロジェクト構築/01_CICD構築.md)
- 実装: [`.github/workflows/ci.yaml`](../../.github/workflows/ci.yaml)
