...
→ 詳細: [03_インフラとDB設計.md 7.1.3 節](03_インフラとDB設計.md)、[ADR-044](../70_ADR/044_PostgreSQL_RLSによるマルチテナント分離の実装方式.md)
...
→ 詳細: [ADR-045](../70_ADR/045_DynamoDBによる監査ログストア設計.md)
...
- データベース設計: [40_詳細設計書/02_データベース設計.md](../40_詳細設計書/02_データベース設計.md)
- API 設計: [40_詳細設計書/03_API設計.md](../40_詳細設計書/03_API設計.md)
