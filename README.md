...
AI にコードを書かせること自体は容易になった。

しかし「正しく」「高品質に」書かせ続けるのは別の問題で、プロンプトの工夫だけでは AI は同じミスを繰り返す。
...
- [俯瞰・実装リズム](.claude/rules/zoom-rhythm.md) — 設計と実装を往復し、理想と現状のギャップがゼロになったことを確認してから提出
