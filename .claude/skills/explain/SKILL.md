...
- diff モード: `PR<番号>` は当該 PR 番号。複数 PR にまたがる場合は最初の PR 番号
- feature モード: 機能名のみ（PR プレフィックスなし）
- `NN` はディレクトリ内の次の連番
- 命名規則の詳細: [`docs/90_実装解説/README.md`](../../../docs/90_実装解説/README.md#命名規則)
