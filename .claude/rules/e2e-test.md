...
E2E テストはテストピラミッドの最上位（5%）。以下の原則に従う。→ [テストピラミッドの概念整理](../../docs/06_ナレッジベース/methodology/テストピラミッド.md)
...
E2E テストを追加・削除した場合、[E2E テスト突合表](../../docs/08_テスト/E2Eテスト突合表.md)を更新する。
...
- Playwright ナレッジベース: [docs/06_ナレッジベース/devtools/Playwright.md](../../docs/06_ナレッジベース/devtools/Playwright.md)
- API テストルール: [.claude/rules/api-test.md](api-test.md)
- テスト設計方針: [docs/05_ADR/032_テスト設計方針.md](../../docs/05_ADR/032_テスト設計方針.md)
- E2E テスト突合表: [docs/08_テスト/E2Eテスト突合表.md](../../docs/08_テスト/E2Eテスト突合表.md)
