...
各ループで何を検出し、どう対応したかを記録する。この記録は設計の思考過程を可視化し、後続の判断の根拠となる。

「検出したギャップ」を主語にすることで、何を発見したかが明確になる。「観点」列で[ギャップ発見の観点](#ギャップ発見の観点)と接続し、検出内容を分類する。
