...
→ ISO 25010 品質特性との対応: [KB: ISO 25010 > ギャップ発見観点とのマッピング](../../docs/06_ナレッジベース/methodology/ISO25010.md#ギャップ発見観点とのマッピング)
...
| 状態依存フィールド | 特定の状態でのみ有効なフィールドがフラットな型に混在しているもの。型安全ステートマシンで分離すべき（[ADR-054](../../docs/05_ADR/054_型安全ステートマシンパターンの標準化.md)） |
...
- 設計・ドキュメント: 詳細設計書 `docs/03_詳細設計書/XX_xxx.md` 更新済み、ADR該当なし、セッションログ `prompts/runs/2026-02/xxx.md`
