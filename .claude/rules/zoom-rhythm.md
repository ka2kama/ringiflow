...
コミット前に品質チェックリストの「コード品質確認」と「品質向上」がすべて OK であること。Phase 完了後に全体を通して検証する。→ [品質チェックリスト](../../docs/04_手順書/04_開発フロー/01_Issue駆動開発.md#62-品質チェックリスト)
...
テストの理想状態（To-Be）。具体的な確認手順は [品質チェックリスト](../../docs/04_手順書/04_開発フロー/01_Issue駆動開発.md#62-品質チェックリスト) を参照。
...
各 Phase が個別に整合していても、Phase 間の接続でずれが生じることがある。全 Phase 完了後に、PR 全体を俯瞰して検証する。→ [品質チェックリスト](../../docs/04_手順書/04_開発フロー/01_Issue駆動開発.md#62-品質チェックリスト)
