...
例外として許容する場合は、`.config/file-size-exceptions.txt` に理由付きで追加する（ADR-043 の判断プロセスに従う）。
...
選定理由: [ADR-042](../../docs/70_ADR/042_コピペ検出ツールの選定.md)
...
1. [`00_アーキテクチャ概要.md`](../../docs/30_基本設計書/00_アーキテクチャ概要.md) — 構成図、レイヤー表、通信表、セキュリティ境界図
2. [`01_アーキテクチャ設計.md`](../../docs/30_基本設計書/01_アーキテクチャ設計.md) — 詳細構成図、コンポーネント図、レイヤー表
3. [`02_プロジェクト構造設計.md`](../../docs/30_基本設計書/02_プロジェクト構造設計.md) — ディレクトリ構造、Cargo.toml、クレート構成図
