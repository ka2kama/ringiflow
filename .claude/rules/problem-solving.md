...
技術的問題は troubleshooting.md が専用のフレームワークを提供する。本フレームワークは主にプロセス的・思考的問題に適用する。

→ 問題の性質の定義と routing table: [改善記録 > 問題の性質分類](../../prompts/improvements/README.md#対策設計の前提-問題の性質分類必須)
