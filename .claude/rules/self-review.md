...
Ready for Review にする前に、PR 本文の **Self-review セクション** に検証結果を記載する。検証結果が記載されていない PR は Ready for Review にしない。
...
目的: 計画ファイルと同様に、「検証結果の記載」を成果物要件とすることで、Ready for Review 前の自己検証を構造的に強制する。
...
- Ready for Review 前に PR 本文の Self-review セクションに検証結果を記載する
